...
# 设置中文字体
plt.rcParams['font.sans-sdiseases = [
...
for idx, (disease_name, data, color) in enumerate(diseases):
    ...
    elif disease_name == 'Parkinson\\'s Disease':
...
function_expressions = [
    ...
    {
        'name': '2. Parkinson\\'s Disease Gait Pattern (Normalized)',
        'color': 'orange',
        'equations': [
...
print("✅ 已生成基于统一标准化相对运动幅度的四组步态图表:")
print("1. normalized_gait_movement_patterns.png - 四种疾病的标准化运动模式")
print("2. normalized_gait_mathematical_functions.png - 更新的数学函数表达式")
print("3. model_comparison_mixed_vs_unified.png - 原始混合模型 vs 统一标准化模型对比")
print()
print("💡 改进优势:")
print("- 统一物理量：全部为相对运动幅度 [-1,1]")
print("- 便于比较：相同量纲可直接对比")
print("- 疾病特征更清晰：通过幅度和模式差异识别")
print("- 模型一致性：消除混合物理量的概念混乱")
